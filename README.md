...
Готовый пакет Excel v2 (код, `config_excel_v2.json`, Docs): **`v2_program_files_20260911.zip`** в корне репозитория (без тестов; старые `v2_*.zip` удалены). Справочник конфига: [Docs/CONFIG_EXCEL_V2.md](Docs/CONFIG_EXCEL_V2.md) v2.8.0; полный разбор **каждого** ключа: [Docs/CONFIG_EXCEL_V2_PARAMS.md](Docs/CONFIG_EXCEL_V2_PARAMS.md).
...
| 2.9.0 | 2026-09-11 | ToDo v3: Метод продаж, percentiles Excel, filters_order, Статистика-каталог, heartbeat снимка; архив `20260911` |
