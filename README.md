...
| `manager_analytics` | Превышения P80 по менеджерам (КМ) |
| `logging` | Файлы логов |
...
- **Pipeline-фильтры:** левая панель; варианты метки «Стратегия» / «Стратегия·2026» (взаимоисключающие)
- **Фильтры UI:** иконки, мини-кнопки «все/сброс», ресайз правой панели
- **Менеджеры:** отдельный JSON, автозагрузка `kanban_managers_latest.json`
