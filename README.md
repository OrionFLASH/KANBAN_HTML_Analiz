...
- **Графики:** режим «свод + каждый» — сверху все выбранные ТБ или продукты/группы на одном графике, ниже отдельная карточка на каждый ТБ или продукт/группу
- Режим `group_only` в JSON: подписи «группы», фильтр продуктов скрыт
