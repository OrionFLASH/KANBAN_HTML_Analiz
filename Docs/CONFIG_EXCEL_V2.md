...
> **Полный перечень без исключений:** на **каждый** ключ актуального `config_excel_v2.json` есть отдельная карточка (зачем / как / что даёт / от чего зависит / **допустимые значения и эффект вариантов** / значение в config) в  
