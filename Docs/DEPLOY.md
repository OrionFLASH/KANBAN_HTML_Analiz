...
**Версия копии POST:** 2.8.0 (2026-09-10)
...
Только документация: **`docs_20260910d.zip`** — папка `Docs/` (включая **CONFIG_EXCEL_V2_PARAMS.md** — каждый ключ + допустимые значения) + `README.md` + `ROADMAP.md`.
