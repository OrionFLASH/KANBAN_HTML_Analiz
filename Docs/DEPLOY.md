...
| Раздел | Описание |
|--------|----------|
| Левая панель | Загрузка JSON (monolith), **pipeline-фильтры**, агрегация, режим графика |
| Правая панель | Мультивыбор ТБ, групп, продуктов (поиск, сворачивание) |
| Вкладки | **Графики** · **Сводная матрица** · **Менеджеры** |
| Графики линий | «По продуктам/группам», «По ТБ» — кривые «лиды × дни» |
| Графики КМ | «КМ с нарушениями P80…» — bar-chart (вкладка Графики) |
| Матрица | Группа/продукт × стадия; на всю ширину рабочей области |
| Менеджеры | Топ-N по ТБ; клик по КМ — **полноэкранная карточка** с инфографикой и stuck_items |
