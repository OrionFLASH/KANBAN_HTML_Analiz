...
| 12.13 | Percentiles: при split по ТБ — отдельный файл на ТБ (`split_mode=files`) | `percentiles_export`, pipeline | `[v]` |

## Следующий шаг

- Prod-прогон percentiles после file-per-TB (`split_mode=files`)
