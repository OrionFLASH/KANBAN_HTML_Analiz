...
| 11.58 | В карточках параметров: допустимые значения и эффект каждого варианта | Docs | `[v]` |

### 11.58 — Декомпозиция

| # | Подзадача | Статус |
|---|-----------|--------|
| 11.58.1 | Каталог вариантов по коду (mode, report_parts, sort_mode, filters, …) | `[v]` |
| 11.58.2 | Поле «Допустимые значения» во всех карточках PARAMS | `[v]` |
| 11.58.3 | Архив docs_20260910d.zip + PR | `[v]` |
